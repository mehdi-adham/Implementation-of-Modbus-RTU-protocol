...
چون باید بیت های مربوط به آرایه ای از بایت ها رو استخراج کنیم ابتدا ایندکس آرایه رو محاسبه می کنیم. اگر آدرس کویل شروع را بر هشت تقسیم کنیم ایندکس آرایه بدست می آید `COIL_MEM[(coil_counter / 8)]` و برای بدست آوردن اینکه کدام بیت آن آرایه مربوط به آن کویل است ، باقی مانده تقسیم بر هشت را محسابه می کنیم `coil_counter % 8` . 

حالا برای اینکه بدانیم این بیت ۰ است یا ۱ آن را به اندازه ای به راست شیفت می دهیم تا در جایگاه با ارزش مکانی یک قرار گیرد(به اندازه `coil_counter % 8 ` ) که با ۱ and کنیم نتیجه هرچه باشد مقدار آن کویل می شود


در کد زیر می توانید نحوه خواندن مقدار کویل مربوطه از آرایه COIL_MEM را ببینید
