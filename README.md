...
1. 1.	انتخاب حالت ASCII یا RTU (که فقط به شبکه های استاندارد Modbus مربوط می شود)
...
```
2. 2.	کاربران مد مورد نظر را به همراه پارامترهای ارتباطی پورت سریال (نرخ baud، مد parity و غیره) در طول پیکربندی هر کنترلر انتخاب می کنند. پارامترهای مد و سریال باید برای همه دستگاه های موجود در یک شبکه Modbus یکسان باشد.
